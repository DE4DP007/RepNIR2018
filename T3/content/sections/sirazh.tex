...
\chapter{Сиражудинов М.М.}



\section{О G-компактности некоторых классов эллиптических операторов второго порядка}

Аннотация


Здесь рассматриваются вопросы $G$--сходимости некоторых классов недивергентных
...
\item\textbf{ Здесь мы будем придерживаться следующих обозначений:}\\
...
Доказательства этих теорем см. в \cite{DZh}.
...
Доказательство теоремы см. в \cite{SS}.
...
\section{Оценки погрешности усреднения недивергентных
...
Эти результаты анонсированы в заметке \cite{SM}