...
Для доказательства неравенств \eqref{theorem_result}, \eqref{Th1:eq1} и \eqref{Th1:eq2}, нам требуется оценить \linebreak $\left|f(x)-S_{n}(f,x)\right|$, $\left|R_{n,N}(f,x)\right|$, и $|a_{n}^{(2n)}(f)|$ для $f \in C^{0,1}_\Omega$ и $f \in C^2_\Omega$.
