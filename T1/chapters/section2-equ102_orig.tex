...
\end{equation}
Наша цель состоит в том, чтобы сконструировать итерационный процесс для нахождения приближенных значений коэффициентов $c_k=m\hat \eta_{1,k+1}$ $(k=0,1,\ldots)$. Для этого обратимся к соотношениям \eqref{equ102-1.7} и \eqref{equ102-2.1}, которые вместе с \eqref{equ102-3.5} дают
...
Ряд Фурье функции $\eta\in W^r_{L^2(0,1)}$ по системе $\mathcal{ X}_r$ имеет следующий вид (см. \eqref{equ102-1.8})
...
\bibitem{Shar2016} {Шарапудинов И.И.}
...
\bibitem{Shar20} Шарапудинов И.И. Ортогональные  по Соболеву системы, порожденные ортогональными функциями // Изв. РАН. Сер. Математическая. 2018. Том. 82. (Принята к печати)
...
\bibitem{Lopez1995} {Lopez G. Marcellan F. Vanassche W.}
...
\bibitem{Shar17} {Шарапудинов И.И.}
...
\bibitem{Lukom2016} {Лукомский Д.С., Терехин П.А.}
...
\bibitem{MMG2016} {Магомед-Касумов М.Г.}
...
\bibitem{DiffUr2017} {Шарапудинов И.И., Магомед-Касумов М.Г.}
...
\bibitem{Shar25} {Шарапудинов И.И.}
