...
p_0^{-\frac12,-\frac12}(x)=\sqrt{1/\pi},\quad  p_n^{-\frac12,-\frac12}(x)=\sqrt{2/\pi}\cos n\theta\quad (n=1,\ldots)
 ...
 Как хорошо известно \cite{sob-jac-discrete-Sege}, система полиномов Якоби \eqref{sob-leg-3.32} полна в $L_\kappa^2(-1,1)$.   Она порождает на $[-1,1]$ систему полиномов  $p_{r,k}^{\alpha,\beta}(x)$ $(k=0,1,\ldots)$, определенных равенствами
...
Доказательство оценок \eqref{sob-leg-3.55}  и \eqref{sob-leg-3.56} основано \cite{Haar-Tcheb-Shar15}, \cite{sob-leg-Shar17}
