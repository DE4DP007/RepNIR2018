...
%В связи с этим ряд Фурье по системе $\{\psi_{r,k}(t)\}_{k=0}^{N+r-1}$ мы будем, следуя \cite{sob-tcheb-difference-Shar9} --  \cite{sob-tcheb-difference-SharII}, называть смешанным рядом по исходной ортонормированной системе $\{\psi_{k}(t)\}_{k=0}^{N-1}$.
%
